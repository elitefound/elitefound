        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-centrado">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php" style="cursor: pointer;">Home</a>
                    </li>
                    <li class="nav-item">
...
<div class="pegarFooter">
    <section class="seccion_oscura py-5 content">
            <form action="controller/confirmarCodigo.php" class="py-5" id="subscribe" method="post">
                ...
                <div id="btnLogin" style="width: 80%;">
